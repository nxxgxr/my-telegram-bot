...
async def about(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    text = (
        ...
        "✅ Увеличение FPS на 20–30%: Оптимизируйте производительность вашей системы, чтобы добиться максимальной частоты кадров даже в самых требовательных играх.\n"
        ...
        "✅ Игровая графика без компромиссов: Наслаждайтесь четкой и плавной картинкой, которая погружает вас в игру.\n\n"
        "➖➖➖➖➖➖➖➖➖➖➖➖➖\n"
